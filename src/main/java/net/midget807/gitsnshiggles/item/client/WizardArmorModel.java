...
public class WizardArmorModel<T extends LivingEntity> extends BipedEntityModel<T> {
    public static final EntityModelLayer MODEL_LAYER = new EntityModelLayer(GitsAndShigglesMain.id("wizard_robes"), "main");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData hat = head.addChild("hat", ModelPartBuilder.create().uv(51, 64).cuboid(-4.5F, -11F, -4.5F, 9F, 6F, 9F, new Dilation(0.05F)), ModelTransform.pivot(0F, 0F, 0F));
        ModelPartData hatTip = hat.addChild("hatTip", ModelPartBuilder.create().uv(100, 79).cuboid(-2.5F, -13.2F, -4.7F, 5F, 4F, 9F, new Dilation(0.05F)), ModelTransform.of(0F, 0F, 0F, -0.6545F, 0F, 0F));
        ModelPartData hatStalk = hat.addChild("hatStalk", ModelPartBuilder.create().uv(87, 64).cuboid(-3.5F, -11.8F, -1.5F, 7F, 6F, 9F, new Dilation(0.05F)), ModelTransform.of(0F, 0F, 0F, 0.2618F, 0F, 0F));
        ModelPartData hatRim = hat.addChild("hatRim", ModelPartBuilder.create().uv(0, 64).cuboid(-9F, -6F, -8.5F, 17F, 2F, 17F, new Dilation(0F)), ModelTransform.of(0F, 0F, 0F, 0F, 0F, 0.1309F));
