...
public class ElfEntityModel extends BipedEntityModel<ElfEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData hat = modelPartData.addChild("hat", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0F, -2.6F, -2.5F, 4.0F, 2.0F, 4.0F, new Dilation(-0.8F))
		.uv(16, 24).cuboid(-1.0F, -2.5F, -1.5F, 2.0F, 1.0F, 2.0F, new Dilation(0.1F))
		.uv(24, 19).cuboid(-1.0F, -3.4F, -1.5F, 2.0F, 1.0F, 2.0F, new Dilation(-0.2F)), ModelTransform.pivot(0.0F, 17.0F, 0.0F));

		ModelPartData ball_r1 = hat.addChild("ball_r1", ModelPartBuilder.create().uv(8, 22).cuboid(-1.0F, -2.3F, -0.25F, 2.0F, 2.0F, 2.0F, new Dilation(-0.6F))
		.uv(16, 19).cuboid(-1.0F, -2.3F, -0.25F, 2.0F, 3.0F, 2.0F, new Dilation(-0.7F)), ModelTransform.of(0.0F, -4.0F, -1.0F, -0.5236F, 0.0F, 0.0F));

		ModelPartData middle_top_r1 = hat.addChild("middle_top_r1", ModelPartBuilder.create().uv(0, 22).cuboid(-1.0F, -1.6F, -0.5F, 2.0F, 2.0F, 2.0F, new Dilation(-0.5F)), ModelTransform.of(0.0F, -3.0F, -1.0F, -0.1745F, 0.0F, 0.0F));
		...
		ModelPartData left_leg = modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(0, 26).cuboid(0.0F, 0.0F, -0.5F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
		.uv(24, 28).cuboid(0.0F, 3.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 20.0F, -0.5F));

		ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(4, 26).cuboid(-1.0F, 0.0F, -0.5F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
		.uv(20, 27).cuboid(-1.0F, 3.0F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 20.0F, -0.5F));
